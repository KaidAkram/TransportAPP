...
file_path = "c:/Users/Akram KAID/Desktop/Entreprise_transport/frontend/src/components/modules/contrats/AddAvenantModal.tsx"
...
with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)
print("AddAvenantModal rewritten successfully.")
