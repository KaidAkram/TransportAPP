...
export default function StockPage() {
  ...
  }, [search, categoryFilter, statusFilter, yearFilter, monthFilter, page, sortBy, sortOrder]);

  
  useEffect(() => {
    setPage(1);
  }, [search, categoryFilter, statusFilter, yearFilter, monthFilter, sortBy, sortOrder]);
