...
def test_seed_execution_and_avatar_assets():
  ...
  driver_avatar = os.path.join(project_root, "frontend", "public", "assets", "avatars", "driver_pro.jpg")
  mechanic_avatar = os.path.join(project_root, "frontend", "public", "assets", "avatars", "mechanic_pro.jpg")
